...
function CMD {        # 测试命令, 随机等待几秒钟
    echo $1
    ./abund_with_same_a_single.py properties_${base}.txt $1
}
...
INPUT_DIR="dot_abund_${base}"
OUTPUT_DIR="dot_abund_png_${base}"
...
./zone_abundance_output ../network/${base}_output.xml "[a <= 60]" "" 1e-30 ${INPUT_DIR}

./abund_with_same_a.py properties_${base}.txt ${INPUT_DIR} ${OUTPUT_DIR}
# #///////////////////////////////////////////////////////////////////////////////
