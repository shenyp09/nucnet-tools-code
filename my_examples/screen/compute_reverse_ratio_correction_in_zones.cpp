...
//!
//! \file
//! \brief Example code to compute the reverse ratio correction factors for
//!    reactions in zones in a output network xml file.
//!
////////////////////////////////////////////////////////////////////////////////
...
get_input( int argc, char **argv )
{
  ...
  try
  {
    ...
    std::string s_purpose = "\nPurpose: compute the reverse ratio correction factors for reactions in zones in xml_file for the selected nuclei, reactions, and zones.";
...
int main( int argc, char * argv[] ) {
  ...
  boost::format fmt3(
    "\n\t\t\tReaction\t\t\t  NSE Correction Factor\n"
  );
